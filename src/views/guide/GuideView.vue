    ...
    <article class="doc">
      ...
      <section id="admin">
        ...
        <ul>
          ...
          <li><b>ตั้งค่า Permissions</b> — ติ๊กว่าแต่ละบทบาททำอะไรได้ · แต่ละสิทธิ์บอกว่าเปิดเมนูหรือปุ่มไหน · admin มีทุกสิทธิ์เสมอ</li>
        </ul>
      ...
      <section id="settings">
        ...
        <ul>
          ...
          <li>
            ...
            <div class="note">
              ระบบลองเรียกผู้ให้บริการด้วย key ใหม่ก่อน ใช้ไม่ได้จะไม่บันทึก (key เดิมยังใช้ต่อ) ·
              OpenAI-compatible ต้องกรอก Base URL ในหน้าต่างเดียวกันด้วย · key ถูกเข้ารหัสก่อนเก็บ หน้าเว็บเห็นแค่ 4 ตัวท้าย ·
      ...
      <section id="trouble">
        ...
        <dl class="faq">
          ...
          <dd>บทบาทของคุณไม่มีสิทธิ์เมนูนั้น — ติดต่อผู้ดูแลให้เพิ่มสิทธิ์ในหน้า "ตั้งค่า Permissions"</dd>
        </dl>
      </section>
    </article>
  </div>
